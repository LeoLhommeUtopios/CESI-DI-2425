### Sujet : Système de Gestion d'Inventaire pour un Magasin
 
#### Contexte :
Un magasin souhaite développer une application pour gérer son inventaire, ses ventes et ses clients. L'application doit permettre aux employés de suivre les stocks, de gérer les ventes et de tenir à jour les informations des clients.
