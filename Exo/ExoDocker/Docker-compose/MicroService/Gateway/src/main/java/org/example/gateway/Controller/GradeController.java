...
public class GradeController {
    ...
    public ResponseEntity<GradeDtoResponse> getById (@PathVariable("id") long id) {
        RestClient<GradeDtoResponse> gradeDtoResponseRestClient = new RestClient<>("http://grade:"+ portGrade+"/api/grade/"+id);
    ...
    public ResponseEntity<GradeDtoResponse> addGrade (@RequestBody GradeDtoReceive gradeDtoReceive) throws JsonProcessingException {
        RestClient<GradeDtoResponse> gradeDtoResponseRestClient = new RestClient<>("http://grade:"+portGrade+"/api/grade");
